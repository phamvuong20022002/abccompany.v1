// -----data input ------
const onedriver = localStorage.getItem("oneDriverCode");
const type_detailDriver = localStorage.getItem("type_detailDriver");

// localStorage.removeItem("oneStaffCode");
const BASE_URL = "http://localhost:8082"
let url_Display = BASE_URL + "/staff/getonedriver/" + onedriver
...
async function form_Display(){
    console.log(update_button_status, type_detailDriver)
    // display alert
    if((update_button_status === "on") && (type_detailDriver === "VIEW")){ 
...
if(onedriver === null){
    ...
    // alert(onedriver + "type_detailDriver: " + type_detailDriver)
    form_Display()
}
